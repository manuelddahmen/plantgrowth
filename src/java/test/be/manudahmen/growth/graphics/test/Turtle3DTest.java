...
import be.manudahmen.growth.graphics.Rotation2;
...
import static be.manudahmen.growth.graphics.Rotation.rotate;
        ...
        public void testScene() {
            ...
            for (int axeNo = 0; axeNo < 10; axeNo++) {
                ...
                for (int i = 0; i < MAX; i++) {
                    ...
                    be.manudahmen.growth.graphics.Rotation rotation = new Rotation(random, Point3D.Y, 2 * Math.PI * i / MAX);
